...
class ContenidoLista extends Component{
    ...
    redirigirFormulario(e){
        browserHistory.push('/departamentoformulario/'+e.target.value);
    }
...
export default class DepartamentoListado extends Component{
    			...
    			<div className="col-lg-12">
    		              <div className="card">
    		                <div className="card-header d-flex align-items-center">
    		                  <h3><i className="fa fa-list"></i> Listado de Departamentos</h3>
    		                </div>
                            <p align="left"></p>
                            <p align="center">
